...
var modalNameInput = document.querySelector('.modal-form__username-button');
var modalContent = document.querySelector('.modal');
if (modal) {
  modalOpenButton.addEventListener('click', function () {
    modalContent.focus();
    var focusableElementsString = 'input:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]';
...
function FormMasked() {
  ...
  for (var _i = 0; _i < maskedInputs.length; _i++) {
    maskedInputs[_i].addEventListener('focusout', maskOutput);
  }
  function maskInput() {
...
var dropMenu = document.querySelectorAll('.footer-menu');
var noJsFooterSections = document.querySelector('.footer-sections__list');
var noJsFooterContacts = document.querySelector('.footer-contacts__list');
...
var adoutAsBlock = document.querySelector('.about-us__info');
var dropButton = document.querySelector('.about-us__info-button');
var dropInfo = document.querySelector('.about-us__info-description-drop-info');
if (adoutAsBlock) {
